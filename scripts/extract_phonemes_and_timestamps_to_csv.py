...
#DELETE ALL THE CASE NOT FOUND INAUDIO LINES FIRST
#DELETE ALL THE CASE NOT FOUND INAUDIO LINES FIRST
#DELETE ALL THE CASE NOT FOUND INAUDIO LINES AND THE UNCLEAR WORDS
#"alignedWord": "<unk>"
...
'''
STEPS:
1. get gentle txt file
2. remove the "case not found" and "<unk>"
3. run it throw the code
'''
import csv

def phonemes_and_timestamps_to_csv(dirname):
	...
	with open('phonemes_start_end.csv', 'w') as g:
		writer = csv.writer(g)
...
if __name__ == '__main__':
	...
	phonemes_and_timestamps_to_csv('align_example.txt')
